      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className={cardCls}>
          <CardHead
            ...
            title="최근 경기 요약"
            action={
              <button onClick={() => go("matches")} className="text-gray-500 hover:text-brand-600">
                ›
              </button>
            }
          />
          {recent.match ? (
            <>
              ...
              <div className="grid grid-cols-3 gap-2 rounded-md border border-gray-200 bg-gray-50 p-3 text-center">
                {[
        ...
        <ol className="space-y-1.5">
          {rows.map((a, i) => (
            <li key={a.memberId} className="flex items-center gap-2 text-sm">
              ...
              <span className="w-10 text-right font-semibold text-gray-900">{unit(a)}</span>
            </li>
          ))}
        </ol>
      )}
