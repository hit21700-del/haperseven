...
const STATUS_OPTIONS: { value: PaymentStatus; label: string; cls: string }[] = [
  { value: "PAID", label: "✔ 납부", cls: "bg-emerald-50 text-emerald-600 ring-emerald-300" },
  { value: "UNPAID", label: "✖ 미납", cls: "bg-red-50 text-red-500 ring-red-300" },
  { value: "EXEMPT", label: "— 면제", cls: "bg-gray-100 text-gray-500 ring-gray-300" },
  { value: "UNKNOWN", label: "○ 지우기", cls: "bg-white text-gray-400 ring-gray-300" },
];
  ...
  return (
    ...
    >
      ...
      <div className="mb-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div>
          <div className="mb-1 text-xs font-semibold text-gray-600">기간 (반기)</div>
        ...
        <div>
          <div className="mb-1 text-xs font-semibold text-gray-600">등록할 상태</div>
      ...
      <div className="mb-2 flex items-center gap-2">
        ...
        <button onClick={toggleAll} className="whitespace-nowrap text-xs font-medium text-brand-600 hover:text-brand-700 hover:underline">
          {allChecked ? "전체 해제" : "전체 선택"}
        </button>
        <button onClick={pickFeeOnly} className="whitespace-nowrap text-xs font-medium text-brand-600 hover:text-brand-700 hover:underline">
          회비 대상만
        </button>
      </div>
      ...
      <p className="mt-2 text-xs text-gray-400">
        ...
        <span className="inline-block h-2 w-2 rounded-full bg-emerald-500" /> 납부{" "}
