...
const baseInput =
  "w-full rounded-lg border border-[#D8DCE5] bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#635BFF] focus:outline-none focus:ring-[3px] focus:ring-[#635BFF]/10";
